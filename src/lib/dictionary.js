export const dictionary = {
    ...
    ["highlighted-projects"]: [

        {
            ...
            altText: "Screenshot of the ArchUI component library showing blueprint-styled UI components and design tokens",
        ...
        },
        {
            ...
            altText: "Homepage of the MobileKangaroo website featuring device repair services and store locations",
            ...
            altText: "Dashboard interface showing order management and Stripe payment integration",
        ...
        },
        {
            ...
            altText: "Landing page with illustrated book covers and parenting content sections",
            url: "https://bb4md.com",
            ...
            bullets: [
                {
                    ...
                    description: {
                        en: "Implementation of an e-commerce for the sale of books focused on new parents, with local distribution in British Columbia, Canada.",
                        es: "Inclusión de un e-commerce para la venta de libros enfocada a nuevos padres de familia, con distribución local en British Columbia, Canadá.",
                    },
                },
                {
                    title: {
                    ...
                    description: {
                        en: "The aesthetics and format of the BB4MD books was replicated in CSS for the landing page, giving the impression that it is a digital book.",
                        es: "La estética y formato de los libros de BB4MD fue replicado en CSS para la landing page, dando la impresión de que se trata de un libro digital.",
                    },
                },
                {
                    title: {
                    ...
                    description: {
                        en: "The prototypes of the sections of the landing page were created in Figma, and then implemented in Wix.",
                        es: "Los prototipos de las secciones de la landing page fueron creados en Figma, y luego implementados en Wix.",
                    }
                }
            ]
        },
        {
            ...
            altText: "Crypto landing page with glassmorphism cards and isometric illustrations on a dark blue gradient",
            ...
            bullets: [
                {
                    ...
                    description: {
                        en: "A gray-blue palette was chosen, contrasted with yellow accents, with glassmorphism effects to play with the depth levels of the website.",
                        es: "Se optó por una paleta de colores grisácea-azulada, contrastado con acentuaciones amarillentas, con efectos de glassmorphism para jugar con los niveles de profundidad de la página web.",
                    }
                },
                {
                    title: {
                    ...
                    description: {
                        en: "The design adapts to different screens, ensuring the adaptability of all customized components.",
                        es: "El diseño se adapta a distintas pantallas, asegurando la adaptabilidad de todos los componentes personaliazados.",
                    }
                },
                {
                    title: {
                    ...
                    description: {
                        en: "Isometric geometric illustrations were created to give a modern and innovative look to each section of the landing page.",
                        es: "Se crearon ilustraciones isométricas de trazos geométricos para darle un aspecto moderno e innovador a cada sección de la landing page.",
                    }
                },
            ],
        },
        {
            ...
            altText: "Interactive gallery displaying 3D-rendered architectural projects and computational design work",
