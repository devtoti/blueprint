...
{#snippet card(
  ...
  <article class="floor-plan-1">
    <div class="north-facade">
      ...
      <div class="void"></div>
      <div class="wall-end" style="transform: rotate(180deg);"></div>
...
<style>
  ...
  div[class*="wall-"] {
    ...
    border: 2px solid var(--bleu-50);
    -moz-box-shadow:
      1px 0 0 var(--bleu-400),
      0 1px 0 var(--bleu-400),
      0 -1px 0 var(--bleu-400),
      -1px 0 0 var(--bleu-400);
    -webkit-box-shadow:
      1px 0 0 var(--bleu-400),
  ...
  .wall-end {
    ...
    box-shadow:
      1px 0 0 var(--bleu-400),
      0 1px 0 var(--bleu-400),
      0 -1px 0 var(--bleu-400) !important;
  }
  .wall-end::after {
    border-left: none !important;
  }
  ...
  .vertical {
    box-shadow:
      1px 0 0 var(--bleu-400),
      -1px 0 0 var(--bleu-400) !important;
    border: 2px solid var(--bleu-50) !important;
    border-top: none !important;
    border-bottom: none !important;
  }
  .vertical::after {
    border: 2px solid var(--bleu-700) !important;
    border-top: none !important;
    border-bottom: none !important;
  }
  .wall-end.vertical {
  ...
  .wall-end.vertical::after {
    border-bottom: 2px solid var(--bleu-700) !important;
  }
  .wall-corner {
    position: relative;
    border: 2px solid var(--bleu-50) !important;
  ...
  .south-facade {
    width: 100%;
    display: grid;
    grid-template-columns: 18px repeat(2, 1fr) 3fr repeat(2, 1fr) 18px;
    gap: 0;
  }
  .middle-facade {
    display: grid;
  ...
  :global([data-theme="dark"]) {
    ...
    div[class*="wall-"] {
      ...
      -moz-box-shadow:
        1px 0 0 var(--bleu-600),
        0 1px 0 var(--bleu-600),
        0 -1px 0 var(--bleu-600),
        -1px 0 0 var(--bleu-600);
      -webkit-box-shadow:
        1px 0 0 var(--bleu-600),
    ...
    .wall-end {
      ...
      box-shadow:
        ...
        0 -1px 0 var(--bleu-300) !important;
    }
    ...
    .vertical {
      box-shadow:
        1px 0 0 var(--bleu-300),
        -1px 0 0 var(--bleu-300) !important;
      border: 2px solid var(--bleu-50) !important;
      border-top: none !important;
      border-bottom: none !important;

      &::after {
        border: 2px solid var(--blue-radix-800) !important;
        border-top: none !important;
        border-bottom: none !important;
      }
    }
    ...
    .wall-end.vertical {
      ...
      &::after {
        border-bottom: 2px solid var(--blue-radix-800) !important;
      }
    }
